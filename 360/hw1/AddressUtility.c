...
PrintSocketAddress()
SockAddrsEqual()
These routines are used to print out the socket addresses and check if 
the addresses of the two sockets are the same.
*/
#include <stdio.h>
#include <string.h>
#include <stdbool.h>
#include <arpa/inet.h>
/*
This function is called once in the server to print out 
the socket address.
*/
...
/*
This function tests the equality of the socket addresses that are put into it.
*/
