...
CPSC 2121-001
In this lab, we encode an arbitrary sequence from "left to right" 
within its inorder traversal.
*/
#include <iostream>
#include <fstream>
#include <cstdlib>
...
{
  //the insert_random function is used instead of the insert function
  //because the randomized balancing mechanism runs faster than the regular
  //one used in insert(), so all insert functions from here to the end of
  //the file were replaced with insert_random functions.
  Node *T = NULL;
