...
class light_t
{
 	...
 	virtual void  add_glint(
		object_t *hitobj, vec_t *base, vec_t *dir, drgb_t *pixel);
...
class triangle_t: public plane_t
{
public:
   	triangle_t();
   	triangle_t(FILE *, model_t *, int);
...
class fplane_t: public plane_t
{
        ...
        vec_t       xdir;
     	vec_t 	    projxdir; //this is xdir projected onto the plane.
};
